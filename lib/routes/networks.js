...
Router.route('/networks/:networkId', {
    ...
    action: function () {
        if (!this.ready())  this.render("loading");
        else this.render('single', { data : {"networkId" : this.params.networkId} });
    }
});
...
Router.route('/networks/:networkId/view', {
    ...
    action: function () {
        if (!this.ready())  this.render("loading");
        else this.render('view', { data : {"networkId" : this.params.networkId} });
    }
});
...
Router.route('/networks/:networkId/share', {
    ...
    action: function () {
        if (!this.ready())  this.render("loading");
        else this.render('share', { data : {"networkId" : this.params.networkId} });
    }
});
...
Router.route('/networks/:networkId/timeline', {
    ...
    action: function () {
        if (!this.ready())  this.render("loading");
        else this.render('timeline', { data : {"networkId" : this.params.networkId} });
    }
});
...
Router.route('/networks/:networkId/map', {
    ...
    action: function () {
        if (!this.ready())  this.render("loading");
        else this.render('map', { data : {"networkId" : this.params.networkId} });
    }
});
